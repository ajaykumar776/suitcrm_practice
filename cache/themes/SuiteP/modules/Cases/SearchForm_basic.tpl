...
<input type='text' name='{$fields.name_basic.name}'
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Cases'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
value="1" title='' tabindex="-1" {$checked} >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='favorites_only_basic' >{sugar_translate label='LBL_FAVORITES_FILTER' module='Cases'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
