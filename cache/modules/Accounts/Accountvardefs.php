<?php 
 $GLOBALS["dictionary"]["Account"]=array (
  ...
  array (
    ...
    'total_opportunity_amount_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Total opportunity amount',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'total_opportunity_amount_c',
      'vname' => 'LBL_TOTAL_OPPORTUNITY_AMOUNT',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Accountstotal_opportunity_amount_c',
      'custom_module' => 'Accounts',
    ),
