<?php 
 $GLOBALS["dictionary"]["CLIT_Client"]=array (
  'table' => 'clit_client',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'clit_client_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'clit_client_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'clit_client_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_clit_client',
    ...
    'clit_client_type' => 
    array (
      'name' => 'clit_client_type',
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'clit_client_type_dom',
      'len' => 50,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'clit_client_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'clit_client_email_addresses',
      'module' => 'EmailAddress',
      'source' => 'non-db',
    ...
    array (
      ...
      'studio' => 'visible',
      'dbType' => 'enum',
      'parentenum' => 'country_name',
      'id' => 'CLIT_Clientstate_name_c',
      'custom_module' => 'CLIT_Client',
    ),
    'country_name_c' => 
    array (
      'inline_edit' => '1',
