...
/* Smarty version 4.3.1, created on 2024-07-01 21:11:52
  from '/opt/lampp/htdocs/SuiteCRM-7.14.4/cache/themes/SuiteP/modules/Cases/DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6682ff78732061_34967929',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bca8142f984a8758580a934b30d8546b2e3942e1' => 
    array (
      0 => '/opt/lampp/htdocs/SuiteCRM-7.14.4/cache/themes/SuiteP/modules/Cases/DetailView.tpl',
      1 => 1719861112,
      2 => 'file',
    ),
  ),
...
function content_6682ff78732061_34967929 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/opt/lampp/htdocs/SuiteCRM-7.14.4/include/Smarty/plugins/function.sugar_include.php','function'=>'smarty_function_sugar_include',),1=>array('file'=>'/opt/lampp/htdocs/SuiteCRM-7.14.4/include/Smarty/plugins/function.sugar_translate.php','function'=>'smarty_function_sugar_translate',),2=>array('file'=>'/opt/lampp/htdocs/SuiteCRM-7.14.4/include/Smarty/plugins/modifier.strip_semicolon.php','function'=>'smarty_modifier_strip_semicolon',),3=>array('file'=>'/opt/lampp/htdocs/SuiteCRM-7.14.4/include/Smarty/plugins/function.counter.php','function'=>'smarty_function_counter',),4=>array('file'=>'/opt/lampp/htdocs/SuiteCRM-7.14.4/include/Smarty/plugins/function.sugar_ajax_url.php','function'=>'smarty_function_sugar_ajax_url',),5=>array('file'=>'/opt/lampp/htdocs/SuiteCRM-7.14.4/include/Smarty/plugins/modifier.escape.php','function'=>'smarty_modifier_escape',),));
?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="country_c">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="country_c" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['country_c']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>



<?php if (is_string($_smarty_tpl->tpl_vars['fields']->value['country_c']['options'])) {?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['country_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['country_c']['options'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['country_c']['options'];?>

<?php } else { ?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['country_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['country_c']['value'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['country_c']['options'][$_smarty_tpl->tpl_vars['fields']->value['country_c']['value']];?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="state_c">
...
<?php if (!$_smarty_tpl->tpl_vars['fields']->value['state_c']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>



<?php if (is_string($_smarty_tpl->tpl_vars['fields']->value['state_c']['options'])) {?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['state_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['state_c']['options'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['state_c']['options'];?>

<?php } else { ?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['state_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['state_c']['value'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['state_c']['options'][$_smarty_tpl->tpl_vars['fields']->value['state_c']['value']];?>
...
<div class="col-xs-12 col-sm-6 detail-view-row-item" data-field="city_c">
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="city_c" >

<?php if (!$_smarty_tpl->tpl_vars['fields']->value['city_c']['hidden']) {
echo smarty_function_counter(array('name'=>"panelFieldCount",'print'=>false),$_smarty_tpl);?>



<?php if (is_string($_smarty_tpl->tpl_vars['fields']->value['city_c']['options'])) {?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['city_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['city_c']['options'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['city_c']['options'];?>

<?php } else { ?>
<input type="hidden" class="sugar_field" id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['city_c']['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['city_c']['value'];?>
">
<?php echo $_smarty_tpl->tpl_vars['fields']->value['city_c']['options'][$_smarty_tpl->tpl_vars['fields']->value['city_c']['value']];?>
