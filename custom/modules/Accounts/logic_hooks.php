...
$hook_array['after_save'][] = array(
    81,
    'Update Related Records After Account Save', // Description
    'custom/modules/Accounts/AccountLogic.php', // File containing the logic
    'AccountLogic', // Class name
    'updateRelatedRecords' // Method to execute
);
