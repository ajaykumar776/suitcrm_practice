...
$hook_array['after_save'][] = Array(79,'Update Account Total Opportunity Amount','custom/modules/Opportunities/UpdateAccountOpportunityAmount.php','UpdateAccountOpportunityAmount','updateTotalAmount');
...
// $hook_array['before_delete'][] = array(
//     1,
//     'Delete associated accounts on Opportunity delete',
//     'custom/modules/Opportunities/DeleteAssociatedAccounts.php',
//     'DeleteAssociatedAccounts',
//     'deleteAccountsOnOpportunityDelete'
// );
?>