...
// Add the new logic hook for auto-incrementing the case_number_c field
$hook_array['before_save'][] = Array(78, 'Auto Increment Case Number', 'custom/modules/Cases/CaseNumberIncrement.php','CaseNumberIncrement', 'setCaseNumber'); 
...
$hook_array[' '][] = Array(77, 'deleteRelationship', 'modules/Cases/CasesJjwg_MapsLogicHook.php','CasesJjwg_MapsLogicHook', 'deleteRelationship'); 
